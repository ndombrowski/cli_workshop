...
\begin{tcolorbox}[enhanced jigsaw, breakable, colbacktitle=quarto-callout-important-color!10!white, toprule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, colframe=quarto-callout-important-color-frame, opacityback=0, colback=white, left=2mm, coltitle=black, bottomtitle=1mm, titlerule=0mm, toptitle=1mm, arc=.35mm, rightrule=.15mm, bottomrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6]
