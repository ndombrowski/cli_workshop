...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, breakable, boxrule=0pt, colback={codebgcolor}, sharp corners, frame hidden]}{\end{tcolorbox}}\fi
\makeatother
\ifLuaTeX
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomtitle=1mm, toprule=.15mm, colback=white, colbacktitle=quarto-callout-important-color!10!white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, coltitle=black, opacitybacktitle=0.6, bottomrule=.15mm, left=2mm, colframe=quarto-callout-important-color-frame, breakable, titlerule=0mm, opacityback=0, leftrule=.75mm, toptitle=1mm, rightrule=.15mm]
