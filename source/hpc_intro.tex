...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, sharp corners, boxrule=0pt, colback={codebgcolor}, breakable, enhanced]}{\end{tcolorbox}}\fi
\makeatother
\ifLuaTeX
