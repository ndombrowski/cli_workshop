...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-caution-color-frame, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Exercise}, titlerule=0mm, toptitle=1mm, left=2mm, colbacktitle=quarto-callout-caution-color!10!white, bottomtitle=1mm, coltitle=black, breakable, colback=white, arc=.35mm, bottomrule=.15mm, rightrule=.15mm, leftrule=.75mm, opacityback=0, toprule=.15mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip: sbatch and better log files}, titlerule=0mm, toptitle=1mm, left=2mm, colbacktitle=quarto-callout-tip-color!10!white, bottomtitle=1mm, coltitle=black, breakable, colback=white, arc=.35mm, bottomrule=.15mm, rightrule=.15mm, leftrule=.75mm, opacityback=0, toprule=.15mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Advanced tip: sbatch arrays to run multiple files in parallel}, titlerule=0mm, toptitle=1mm, left=2mm, colbacktitle=quarto-callout-tip-color!10!white, bottomtitle=1mm, coltitle=black, breakable, colback=white, arc=.35mm, bottomrule=.15mm, rightrule=.15mm, leftrule=.75mm, opacityback=0, toprule=.15mm, opacitybacktitle=0.6]
