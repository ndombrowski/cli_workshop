...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, left=2mm, colframe=quarto-callout-important-color-frame, bottomrule=.15mm, opacityback=0, toprule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, bottomtitle=1mm, arc=.35mm, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, colback=white, rightrule=.15mm, breakable, colbacktitle=quarto-callout-important-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, left=2mm, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, opacityback=0, toprule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, bottomtitle=1mm, arc=.35mm, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip: moving data from the HPC to our own computer}, colback=white, rightrule=.15mm, breakable, colbacktitle=quarto-callout-tip-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, left=2mm, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, opacityback=0, toprule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, bottomtitle=1mm, arc=.35mm, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip: moving data from the HPC using wildcards}, colback=white, rightrule=.15mm, breakable, colbacktitle=quarto-callout-tip-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, left=2mm, colframe=quarto-callout-caution-color-frame, bottomrule=.15mm, opacityback=0, toprule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, bottomtitle=1mm, arc=.35mm, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Exercise}, colback=white, rightrule=.15mm, breakable, colbacktitle=quarto-callout-caution-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, left=2mm, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, opacityback=0, toprule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, bottomtitle=1mm, arc=.35mm, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip: sbatch and better log files}, colback=white, rightrule=.15mm, breakable, colbacktitle=quarto-callout-tip-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, left=2mm, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, opacityback=0, toprule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, bottomtitle=1mm, arc=.35mm, coltitle=black, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Advanced tip: sbatch and multiple files}, colback=white, rightrule=.15mm, breakable, colbacktitle=quarto-callout-tip-color!10!white]
...
using a package management system, such as conda or mamba. These tools
allow you to find and install packages in their own environment without
administrator privileges. Let'go through a very brief example:

\subsection{Install mamba}\label{install-mamba}

A lot of system already come with conda installed, however, if possible
we recommend working with mamba instead of conda. mamba is a drop-in
...
sequences or average sequence length.
...
\CommentTok{\#create an empty environment and name it seqkit}
\ExtensionTok{mamba}\NormalTok{ create }\AttributeTok{{-}n}\NormalTok{ seqkit}

\CommentTok{\#install some software, i.e. seqkit, into the seqkit environment}
\ExtensionTok{mamba}\NormalTok{ install }\AttributeTok{{-}n}\NormalTok{ seqkit }\AttributeTok{{-}c}\NormalTok{ bioconda seqkit}

\CommentTok{\#to run the tool activate the environment first}
\ExtensionTok{mamba}\NormalTok{ activate seqkit}
...
\CommentTok{\#leave the environment}
\ExtensionTok{conda}\NormalTok{ deactivate}
\end{Highlighting}
\end{Shaded}

When installing the seqkit package we specify that we want to look for
seqkit in the bioconda channel with the option \texttt{-c}. Channels are
the locations where packages are stored. They serve as the base for
hosting and managing packages. Conda packages are downloaded from remote
channels, which are URLs to directories containing conda packages. If
you are unable to find a package it might be that you need to specify a
channel.

Unsure if a software can be installed with conda? Google conda together
with the software name, which should lead you do a conda web page, which
also should inform you whether you need to add a specific channel to
