...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-important-color-frame, coltitle=black, opacitybacktitle=0.6, arc=.35mm, opacityback=0, bottomrule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, breakable, bottomtitle=1mm, toptitle=1mm, toprule=.15mm, colbacktitle=quarto-callout-important-color!10!white, titlerule=0mm, colback=white, rightrule=.15mm, left=2mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, coltitle=black, opacitybacktitle=0.6, arc=.35mm, opacityback=0, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip: Moving data from the HPC to our own computer}, breakable, bottomtitle=1mm, toptitle=1mm, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, colback=white, rightrule=.15mm, left=2mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, coltitle=black, opacitybacktitle=0.6, arc=.35mm, opacityback=0, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip: Moving data from the HPC using wildcards}, breakable, bottomtitle=1mm, toptitle=1mm, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, colback=white, rightrule=.15mm, left=2mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, coltitle=black, opacitybacktitle=0.6, arc=.35mm, opacityback=0, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip: Moving files using the FileZilla GUI}, breakable, bottomtitle=1mm, toptitle=1mm, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, colback=white, rightrule=.15mm, left=2mm, leftrule=.75mm]
...
\includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio]{../img/sinfo.png}\hfill
...
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{../img/squeue.png}\hfill
...
\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{srun} \AttributeTok{{-}{-}cpus{-}per{-}task}\OperatorTok{=}\NormalTok{1 }\AttributeTok{{-}{-}mem}\OperatorTok{=}\NormalTok{1G }\AttributeTok{{-}{-}time}\OperatorTok{=}\NormalTok{00:10:00 echo }\StringTok{"Hello interactively"}
\end{Highlighting}
\end{Shaded}
...
\item
  \texttt{-\/-time=00:10:00} Sets the time limit to 10 minutes
\item
...
\item
  \texttt{-\/-ntasks=1}: Defines the number of tasks to run. Here, we
  would set it to 1 since we want to use echo once
\end{itemize}
...
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{../img/squeue2.png}\hfill

Additionally, after the run is completed, you should see that several
HTML files were generated in our fastqc folder.

\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-caution-color-frame, coltitle=black, opacitybacktitle=0.6, arc=.35mm, opacityback=0, bottomrule=.15mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Exercise}, breakable, bottomtitle=1mm, toptitle=1mm, toprule=.15mm, colbacktitle=quarto-callout-caution-color!10!white, titlerule=0mm, colback=white, rightrule=.15mm, left=2mm, leftrule=.75mm]
...
\CommentTok{\#SBATCH {-}{-}time=1:00:00}
...
\item
  ...
  In our case, we request 1 CPU, 5G of memory and 1 hour time limit.
\item
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, coltitle=black, opacitybacktitle=0.6, arc=.35mm, opacityback=0, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip: sbatch and better log files}, breakable, bottomtitle=1mm, toptitle=1mm, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, colback=white, rightrule=.15mm, left=2mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, coltitle=black, opacitybacktitle=0.6, arc=.35mm, opacityback=0, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Advanced tip: sbatch arrays to run multiple files in parallel}, breakable, bottomtitle=1mm, toptitle=1mm, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, colback=white, rightrule=.15mm, left=2mm, leftrule=.75mm]
...
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{../img/arrays.png}\hfill
...
\includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{../img/arrays2.png}\hfill
...
\tightlist
\item
  Read the license and use arrow down to scroll down. Don't scroll too
  fast, so that you see the next question
\item
  Decide where conda gets installed. You can say yes to the default
  location in your home. But don't forget that for Crunchomics your home
  only has 25G of space. You could also install the miniforge/mambaforge
  folder in your personal folder instead.
\item
  Say yes, when you get asked whether conda should be initialized during
  start up
\item
  Restart the shell (exit the terminal and use ssh to log back in) for
  the changes to take effect
\item
  Check if conda is accessible by running \texttt{conda\ -h}
\end{enumerate}
