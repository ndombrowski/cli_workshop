...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, arc=.35mm, leftrule=.75mm, colframe=quarto-callout-tip-color-frame, opacityback=0, bottomtitle=1mm, toprule=.15mm, coltitle=black, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip: moving data from the HPC using wildcards}, breakable, rightrule=.15mm, bottomrule=.15mm, colback=white, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, arc=.35mm, leftrule=.75mm, colframe=quarto-callout-tip-color-frame, opacityback=0, bottomtitle=1mm, toprule=.15mm, coltitle=black, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Advanced tip: sbatch arrays to run multiple files in parallel}, breakable, rightrule=.15mm, bottomrule=.15mm, colback=white, left=2mm]
