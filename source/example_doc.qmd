...
If you want to see an example for documented code, check out [an example](https://github.com/ndombrowski/cli_workshop/tree/main/example_doc) for how I might have recorded how I analysed some sequence data myself.
