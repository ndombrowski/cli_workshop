...
If you want to see an example for documented code, check out [an example](https://github.com/ndombrowski/cli_workshop/tree/main/example_doc) for how I would might have recorded how I analysed some sequence data myself.

The link above leads you to an example for:

-   How could I use github to make my code available to others
-   How could a "code book" look like? The example you see in the folder is provided a markdown file [here](https://github.com/ndombrowski/cli_workshop/blob/main/example_doc/example_notebook.qmd) and for convience the report was also rendered as a [html](https://github.com/ndombrowski/cli_workshop/blob/main/docs/example_doc/example_notebook.html) to send it to collaborators. To view the report, you need to download it first.
