...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, toptitle=1mm, bottomtitle=1mm, bottomrule=.15mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, breakable, titlerule=0mm, coltitle=black, opacitybacktitle=0.6, leftrule=.75mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, colback=white, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, left=2mm]
