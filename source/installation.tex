...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, coltitle=black, colback=white, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, rightrule=.15mm, left=2mm, opacitybacktitle=0.6, bottomtitle=1mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, arc=.35mm, opacityback=0, toprule=.15mm]
