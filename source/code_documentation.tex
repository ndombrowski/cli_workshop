...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, opacityback=0, colback=white, colbacktitle=quarto-callout-note-color!10!white, breakable, toptitle=1mm, left=2mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, toprule=.15mm, coltitle=black, opacitybacktitle=0.6, bottomtitle=1mm, titlerule=0mm, arc=.35mm]
