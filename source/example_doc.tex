...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, frame hidden, boxrule=0pt, breakable, colback={codebgcolor}, sharp corners]}{\end{tcolorbox}}\fi
\makeatother
\ifLuaTeX
...
\href{https://github.com/ndombrowski/cli_workshop/example_doc}{an
...
\item
  ...
  \href{https://github.com/ndombrowski/cli_workshop/example_doc/example_notebook.qmd}{here}
  and for convience the report was also rendered as a html to send it to
  collaborators.
\end{itemize}
...
\item
  ...
  \href{https://github.com/ndombrowski/cli_workshop/example_doc}{github}
