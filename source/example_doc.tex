...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, boxrule=0pt, sharp corners, colback={codebgcolor}, frame hidden, enhanced]}{\end{tcolorbox}}\fi
\makeatother
\ifLuaTeX
